...
abstract class $PriceCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? id, String? name, int? price, String? tag});
}
...
class _$PriceImpl implements _Price {
  _$PriceImpl({this.id, this.name, this.price, this.tag});
  ...
  @override
  String toString() {
    return 'Price(id: $id, name: $name, price: $price, tag: $tag)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, price, tag);
