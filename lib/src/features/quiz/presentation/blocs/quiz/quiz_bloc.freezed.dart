...
class _$StartedImpl implements _Started {
  const _$StartedImpl({this.lessonId});
  ...
  @override
  String toString() {
    return 'QuizEvent.started(lessonId: $lessonId)';
  }
...
abstract class _Started implements QuizEvent {
  const factory _Started({final String? lessonId}) = _$StartedImpl;
...
mixin _$QuizState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<QuizMod> data) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<QuizMod> data)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<QuizMod> data) : _data = data;

  final List<QuizMod> _data;
  @override
  List<QuizMod> get data {
  ...
  @override
  String toString() {
    return 'QuizState.loaded(data: $data)';
  }
...
abstract class _Loaded implements QuizState {
  const factory _Loaded(final List<QuizMod> data) = _$LoadedImpl;
